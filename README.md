...
> [!TIP]
> To initialize .ruby-lsp/Gemfile
> ```sh
> rvm use
...
- search lsp symbols(document and workspace),
- rails stuff like insert binding.pry
- run test
- spec migration

### File browser addition keymaps
